...
class DictionariesControllerTest < ActionController::TestCase
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post :create, dictionary: { example: @dictionary.example, main_word: @dictionary.main_word, meaning: @dictionary.meaning, pronounce: @dictionary.pronounce, type: @dictionary.type }
    end
  ...
  test "should update dictionary" do
    patch :update, id: @dictionary, dictionary: { example: @dictionary.example, main_word: @dictionary.main_word, meaning: @dictionary.meaning, pronounce: @dictionary.pronounce, type: @dictionary.type }
    assert_redirected_to dictionary_path(assigns(:dictionary))
  end
